...
namespace Task_1.Data_Access_Layer
{
    public class SchoolInterceptorTransientErrors : DbCommandInterceptor
    {
        ...
        public override void ReaderExecuting(DbCommand command, DbCommandInterceptionContext<DbDataReader> interceptionContext)
        {
            ...
            {
                _logger.Information("Returning transient error of command: {0}", command.CommandText);
                _counter++;
        ...
        private SqlException CreateDummySqlException()
        {
            ...
            var sqlErrorCtor = typeof(SqlError).GetConstructors(BindingFlags.Instance | BindingFlags.NonPublic).Where(
